...
namespace Woodpecker.Game.Messenger
{
    ...
    public class messengerReactor : Reactor
    {
        public void initializeBuddyList()
        {
            ...
            int maxLengthExtendedList = ObjectTree.Game.Messenger.maxBuddyListLength_Extended;
            Response.appendWired(maxLengthExtendedList);
            Response.appendWired(ObjectTree.Game.Messenger.maxBuddyListLength);
            Response.appendWired(maxLengthExtendedList);

            messengerBuddy[] Buddies = ObjectTree.Game.Messenger.getBuddies(Session.User.ID);
        ...
        public void MESSENGER_MARKREAD()
        {
            ...
            ObjectTree.Game.Messenger.Postmaster.markMessageAsRead(Session.User.ID, messageID);
        }
        /// <summary>
        /// 33 - "@a"
        /// </summary>
        public void MESSENGER_SENDMSG()
        {
            ...
            List<int> buddyIDs = ObjectTree.Game.Messenger.getBuddyIDs(Session.User.ID);
            ...
            ObjectTree.Game.Messenger.Postmaster.sendMessengerMessage(receiverIDs.ToArray(), pMessage);
        }
        /// <summary>
        /// 36 - "@d"
        /// </summary>
        ...
        public void MESSENGER_ACCEPTBUDDY()
        {
            ...
            ObjectTree.Game.Messenger.acceptBuddyRequest(ref this.Session, buddyID);
        }
        /// <summary>
        /// 38 - "@f"
        /// </summary>
        public void MESSENGER_DECLINEBUDDY()
        {
            ...
            ObjectTree.Game.Messenger.declineBuddyRequest(Session.User.ID, buddyID);
        }
        /// <summary>
        /// 39 - "@g"
        /// </summary>
        public void MESSENGER_REQUESTBUDDY()
        {
            ...
            int userID = ObjectTree.Game.Users.getUserID(Username);

            if (userID == 0) // User does not exist
                return;

            if (ObjectTree.Game.Messenger.areBuddies(Session.User.ID, userID, true)) // Already buddies / already request pending
                return;

            ObjectTree.Game.Messenger.requestBuddy(Session.User, userID);
        }
        /// <summary>
        /// 40 - "@h"
        /// </summary>
        public void MESSENGER_REMOVEBUDDY()
        {
            ...
            ObjectTree.Game.Messenger.removeBuddy(Session.User.ID, buddyID);
        }
        /// <summary>
        /// 41 - "@i"
        /// </summary>
        public void FINDUSER()
        {
            ...
            if (userID > 0)
                Response.Append(ObjectTree.Game.Messenger.getBuddy(userID).ToString());
            else
        ...
        {
            messengerMessage[] Messages = ObjectTree.Game.Messenger.getMessages(Session.User.ID);
        ...
        {
            messengerBuddyRequest[] Requests = ObjectTree.Game.Messenger.getBuddyRequests(Session.User.ID);
