    ...
    public partial class flatReactor : roomReactor
    {
        ...
        public void TRADE_DECLINE()
        {
            if (Session.itemStripHandler.tradeAccept)
            {
                ...
                if (ObjectTree.Sessions.getSession(Session.itemStripHandler.tradePartnerSessionID).itemStripHandler.tradeAccept)
                {
        ...
        public void TRADE_ACCEPT()
        {
            if (Session.itemStripHandler.isTrading && !Session.itemStripHandler.tradeAccept)
            {
                ...
                Woodpecker.Sessions.Session partnerSession = ObjectTree.Sessions.getSession(this.Session.itemStripHandler.tradePartnerSessionID);
