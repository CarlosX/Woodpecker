...
namespace Woodpecker.Game.Rooms.Instances.Interaction
{
    ...
    public partial class roomReactor : Reactor
    {
        ...
        public void CHAT()
        {
            ...
            if (!Me.isMuted)
            {
                ...
                if (!this.handleSpecialChatCommand(Text))
                {
                    ...
                    ObjectTree.Game.Moderation.addChatMessageToLogStack(Session.ID, Session.User.ID, Session.roomID, 0, chatType.say, ref Text);
                }
            }
        }
        /// <summary>
        ...
        public void SETBADGE()
        {
            ...
            if(!ObjectTree.Game.Users.userHasBadge(Session.User,newBadge))
                return;
        ...
        public void GET_ALIAS_LIST()
        {
            ...
            Response.Append(ObjectTree.Game.Items.spriteIndex);
            sendResponse();
