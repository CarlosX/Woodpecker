...
namespace Woodpecker.Game.Rooms
{
    ...
    {
        #region Fields
        private Dictionary<int, roomInstance> _Rooms = new Dictionary<int, roomInstance>();
        /// <summary>
        ...
        private Dictionary<int, roomCategoryInformation> _Categories = new Dictionary<int, roomCategoryInformation>();
        #endregion
        ...
        public roomCategoryInformation getRoomCategory(int ID)
        {
            ...
            {
                roomCategoryInformation pCategory = _Categories[ID];
        ...
        {
            if (!_Rooms.ContainsKey(roomID))
                _Rooms.Add(roomID, new roomInstance(roomID));
        ...
        public void destroyInactiveRoomInstances()
        {
            ...
            lock (_Rooms)
            {
                foreach (roomInstance lInstance in _Rooms.Values)
                {
