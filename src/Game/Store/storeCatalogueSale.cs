...
namespace Woodpecker.Game.Store
{
    ...
    public class storeCatalogueSale
    {
        ...
        private string itemIcon
        {
            get
            {
                if (this.isPackage)
                    ...
                    return ObjectTree.Game.Items.generateSpecialSprite(ref this.pItem.Sprite, this.pItemSpecialSpriteID);
            }
        }
        /// <summary>
        ...
        public string Name
        {
            get
            {
                if (this.isPackage)
                    ...
                    return ObjectTree.Game.Items.getItemName(pItem, pItemSpecialSpriteID);
            }
        }
        /// <summary>
        ...
        public string Description
        {
            get
            {
                if (this.isPackage)
                    ...
                    return ObjectTree.Game.Items.getItemDescription(pItem, pItemSpecialSpriteID);
            }
        }
        /// <summary>
        ...
        public stripItem[] getItemInstances()
        {
            ...
            if (!isPackage)
            {
                Items.Add(ObjectTree.Game.Items.createItemFromDefinition(this.pItem, this.pItemSpecialSpriteID));
            }
            else
            {
                foreach(storeCataloguePackageItem lPackageItem in this.pPackageItems)
                {
                    ...
                    {
                        Items.Add(ObjectTree.Game.Items.createItemFromDefinition(lPackageItem.pItem, lPackageItem.specialSpriteID));
                    }
                }
            }
