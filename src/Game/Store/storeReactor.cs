...
namespace Woodpecker.Game.Store
{
    ...
    public class storeReactor : Reactor
    {
        ...
        {
            ObjectTree.Game.Store.sendTransactions(ref this.Session);
        }
        /// <summary>
        /// 129 - "BA"
        /// </summary>
        public void REDEEM_VOUCHER()
        {
            ...
            ObjectTree.Game.Store.redeemVoucher(ref this.Session, Code);
        }
        /// <summary>
        /// 190 - "B~"
        /// </summary>
        public void SCR_BUY()
        {
            ...
            if (ObjectTree.Game.Store.purchaseSubscription(ref this.Session, args[0], int.Parse(args[1])))
            {
        ...
        public void GCIX()
        {
            ...
            storeCataloguePage[] pPages = ObjectTree.Game.Store.getCataloguePages();
        ...
        public void GCAP()
        {
            ...
            storeCataloguePage pPage = ObjectTree.Game.Store.getCataloguePage(pageName);
