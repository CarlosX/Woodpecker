...
namespace Woodpecker.Game.Users
{
    public class userReactor : Reactor
    {
        ...
        public void UPDATE_ACCOUNT()
        {
            ...
            if (ObjectTree.Security.Cryptography.MD5.Hash(Request.getStructuredParameter(13), Session.User.Username.ToLower()) != Session.User.Password)
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (newValue.Length > 0) // New password set
                    {
                        ...
                        Session.User.Password = ObjectTree.Security.Cryptography.MD5.Hash(newValue, Session.User.Username.ToLower());
                    }
