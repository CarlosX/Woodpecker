...
namespace Woodpecker.Game.Users
{
    ...
    public class userManager
    {
        ...
        /// </summary>
        private Dictionary<int, Session> _userSessions = new Dictionary<int, Session>();
        /// <summary>
        /// The current amount of active users on the server.
        /// </summary>
        public int userCount
        {
            get { return _userSessions.Count; }
        }
        #endregion
        ...
        {
            return this._userSessions.ContainsKey(userID);
        }
        /// <summary>
        ...
        {
            if (this._userSessions.ContainsKey(userID))
                return _userSessions[userID].ID;
            else
                return 0;
        }
        ...
        {
            if (_userSessions.ContainsKey(userID))
                return _userSessions[userID].Access;
        ...
        {
            serverMessage hhCast = genericMessageFactory.createMessageBoxCast("Message from staff:<br>" + Text);
